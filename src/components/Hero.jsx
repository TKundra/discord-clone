...
import homeTwo from '../assets/home-2.svg';

const Hero = () => {
  return (
    <div className="bg-discord-blue pb-8 md:pb-0 overflow-hidden">
      <div className="p-7 py-9 h-screen md:h-[83vh] md:flex relative">
        ...
        <div className="flex flex-col gap-7 md:max-w-md lg:max-w-none lg:justify-center ">
          ...
          <div className="flex flex-col sm:flex-row md:flex-col lg:flex-row md:items-start sm:items-center gap-6">
            <button className="bg-white w-60 font-medium flex items-center justify-center rounded-full p-4 text-lg hover:shadow-2xl hover:text-discord-blurple focus:outline-none transition duration-200 ease-in-out">
